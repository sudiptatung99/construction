    ...
    <div class="row g-gs">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="total_mnth_select">
                        <form action="{{ route('report.expense.between') }}" class="d-flex gap-3" method="POST">
                            @csrf
                    ...
                    @endphp
                    @if (count($expense) > 0)
                        @foreach ($expense as $reciveamount)
                            @php
        ...
        <div class="col-xl-12 col-sm-12 px-0">
            <div class="card">
                <div class="card-body">
                    <div class="table_top">
                        <p style="color: #000; font-weight: 500; font-size: 18px;">Expenese</p>
                    ...
                    <table id="selltable" width="100%" class="datatable-init table"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th>
                                    <span class="overline-title">Pay To Whom</span>
                                </th>
                                <th>
