        ...
        <div class="col-xl-12 px-0">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="container">
                        <div class="row">
                            <div class="col">Purchase No.</div>
                            <div class="col">{{$purchase->expeseno}}</div>
                            <div class="w-100"></div>
                            ...
                            <div class="col">{{env('CURRENCY')}}{{number_format($purchase->subtotal,2)}}</div>
                            <div class="w-100"></div>
                            <div class="col">GST</div>
                            <div class="col">{{$purchase->gst}}%</div>
                            <div class="w-100"></div>
                            <div class="col">GST Amount</div>
                            <div class="col">{{env('CURRENCY')}}{{number_format($purchase->gstamount,2)}}</div>
                            <div class="w-100"></div>
                            <div class="col">Total</div>
                            <div class="col">{{env('CURRENCY')}}{{number_format($purchase->total,2)}}</div>
                            <div class="w-100"></div>
                            <div class="col">Payment Mode</div>
                            <div class="col">{{$purchase->payment_mode}}</div>
                            <div class="w-100"></div>
