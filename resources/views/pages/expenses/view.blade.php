            ...
            <div class="card-body">
                <div class="">
                    <div class="d-flex" style="justify-content: space-between;">
                        <h4 style="font-size: 20px;">Expense List</h4>
                        ...
                        <table id="myexpense" width="100%" class="datatable-init table"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th><span class="overline-title">Items</span></th>
                                    <th><span class="overline-title">Pay To Whom</span></th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown-menu drop_option">
                                            <ul>
                                                <li>
                                                    <a href="{{ route('expense.edit', encrypt($item->id)) }}">Edit</a>
                                                </li>
                                                <li>
                                                ...
                                                <form action="{{ route('expense.destory',encrypt($item->id)) }}"
                                                    id="expense{{ $item->id }}" method="POST">
                                            ...
                                            <div class="modal-dialog modal-md">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Are You Sure You Want To Detele This Expense Data</p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-danger"
                                                            onclick="event.preventDefault();
                                                                    document.getElementById('expense{{ $item->id }}').submit();">
                                                            Delete
                                                        </button>
                                                    </div>
                                                </div>
