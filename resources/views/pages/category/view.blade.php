            ...
            <div class="card-body">
                <div class="">
                    <div class="d-flex" style="justify-content: space-between;">
                        <h4 style="font-size: 20px;">Category List</h4>
                        ...
                        <table id="myexpense" width="100%" class="datatable-init table"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$key+1}}</td>
                                    <td>{{ $item->name }}</td>
                                    <td><a href="#" data-bs-toggle="dropdown" aria-expanded="false" class="">
                                        ...
                                        <div class="dropdown-menu drop_option">
                                            <ul>
                                                ...
                                                <form action="{{ route('category.destroy', $item->id) }}"
                                                    id="category{{ $item->id }}" method="POST">
                                            ...
                                            <div class="modal-dialog modal-md">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Are You Sure You Want To Detele This Category</p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-danger"
                                                            onclick="event.preventDefault();
                                                                    document.getElementById('category{{ $item->id }}').submit();">
                                                            Delete
                                                        </button>
                                                    </div>
                                                </div>
