...
@section('content')
                                ...
                                <div class="d-flex gap-3 mt-3">
                                    <div class="form-group col-4">
                                        ...
                                        <div class="form-control-wrap">
                                            <select class="js-select" required data-search="true" name="client_id" data-sort="false">
                                                <option value="">Select</option>
                                                @if ($id != '')
                                                    {{ getClient(decrypt($id)) }}
                                                @else
                                                    {{ getClient('') }}
                                                @endif
                                            </select>
                                    ...
                                    <div class="form-group mb-4 col-3 ">
                                        ...
                                        <div class="form-control-wrap">
                                            <select class="js-select"  data-search="true" name="payment_mode" id="paymentmode"
                                                data-sort="false">
                                                <option value="">Select</option>
                                                {{ getPaymentMode('') }}
                                            </select>
                                    ...
                                    <div class="form-group col-4">
                                        <label for="exampleFormSelect1" required class="form-label">Payment Status</label>
                                        <div class="form-control-wrap">
                                    ...
                                    <div class="form-group col-3" id="ini_amount" style="display:none">
                                        <label for="exampleFormSelect1" id="i_amount"  class="form-label">Initial Amount</label>
                                        <label for="exampleFormSelect1" id="a_amount"  class="form-label">Advance Amount</label>
                                        <div class="form-control-wrap">
                                            <input type="number" id="invalue" value="0" class="form-control"
                                                name="ini_amount">
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-4">
                                <div class="expen_date" style='justify-content:flex-end;gap: 5px;'>
                                    ...
                                    <input type="date" class="form-control" id="start" name="date"
                                        value="{{ date('Y-m-d') }}" style='width: 151px;' />
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="quantity_put">
                                                        <div class="input_div">
                                                            <input type="text" pattern="^(?:0|[1-9]\d*)(?:\.(?!.*000)\d+)?$" required  id="qty0"
                                                                name="addmore[0][qty]" class="form-control form-control">
                                                        </div>
                                                        <div class="form-group">
                                                ...
                                                <td><input type="text"  required name="addmore[0][price]" id="price0" readonly
    ...
    <script>
        ...
        // var thisdate = new Date().toJSON().slice(0, 10);
        // var newdate = moment(thisdate, "YYYY-MM-DD").format(this.getAttribute('DD/MM/YYYY'))
        // alert(newdate);
        // document.getElementById("dateformat").value = format2;
    </script>
    <script>
