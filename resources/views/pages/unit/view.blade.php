                ...
                <div class="card-body">
                    <div class="">
                        <div class="d-flex" style="justify-content: space-between;">
                            <h4 style="font-size: 20px;">Unit List</h4>
                            <a  href="{{route('unit.create')}}" class="btn btn-primary" >Create New Unit</a>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu drop_option">
                                                    <ul>
                                                        <li>
                                                            <a href="{{ route('unit.edit', $item->id) }}">Edit</a>
                                                        </li>
                                                        <li>
                                                    ...
                                                    <div class="modal-dialog modal-md">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>Are You Sure You Want To Detele This Unit</p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="button" class="btn btn-sm btn-danger"
                                                                    ...
                                                                    document.getElementById('unit{{ $item->id }}').submit();">
                                                                    Delete
                                                                </button>
                                                            </div>
                                                        </div>
