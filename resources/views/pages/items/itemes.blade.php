                ...
                <div class="card-body">
                    <div class="row justify-content-between">
                        ...
                        <div class="d-flex" style="justify-content: space-between">
                            <h4 style="margin-bottom: 15px; font-size: 20px;">Items Create</h4>
                            ...
                            <form action="{{route('items.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="item_detail">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <label for="exampleFormControlInputText1" class="mb-1">Measure Unit</label>
                                                <select class="form-select" id="exampleFormSelect1"
                                                    aria-label="Default select example" name="unit_id">
                                                    <option selected hidden>--Select Measure Unit--</option>
                                                   {{onGetUnit('')}}
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="item_detail">
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                ...
                                                <select class="form-select" id="exampleFormSelect1"
                                                    ...
                                                    <option selected hidden> -- select Categoy --</option>
                                                    {{ onGetCategory('') }} 
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-4">
                                        <div class="form-control-wrap">
                                            ...
                                            <input class="form-control" name="image" id="formFileRg" type="file">
                                        </div>
                                        <span class="text-danger">
                                            @error('image')
                                                {{ $message }}
                                ...
                                <div class="pricediv">
                                    ...
                                    <div class="item_price">
                                        ...
                                        <div class="form-group">
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control"
                                                    id="exampleFormControlInputText1" placeholder="Purchase Price">
                                            </div>
                                        </div>
                                                ...
                                                <div class="tab-content" id="myTabContent">
                                                    <div class="tab-pane fade show active" id="custom-home-tab-pane">
                                                        ...
                                                        <div class="total_pricediv">
                                                            <div class="pricediv">
                                                                <h4
                                                                    style="font-size: 15px; color: #000; font-weight: 700;">
                                                                    Purchase Price</h4>
