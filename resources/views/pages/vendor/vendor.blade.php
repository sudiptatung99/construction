            ...
            <div class="card-body">
                <div class="row justify-content-between">
                    ...
                    <div class="d-flex" style="justify-content: space-between">
                        <h4 style="margin-bottom: 15px; font-size: 20px;">Add Vendor </h4>
                                ...
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        ...
                                        <input type="text" name="name" class="form-control" value="{{old('name')}}"
                                            id="exampleFormControlInputText1" placeholder="Enter Vendor Name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        ...
                                        <input type="email" name="email" class="form-control" value="{{old('email')}}"
                                            id="exampleFormControlInputText1" placeholder="Enter Vendor Email">
                                    </div>
                                </div>
                                <span class="text-danger">
                                    @error('email')
                            ...
                            <div class="col-12 mt-2">
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        ...
                                        <input type="number" name="first_number" class="form-control" value="{{old('first_number')}}"
                                            id="exampleFormControlInputText1" placeholder="Enter Vendor Phone Number">
                                    </div>
                                </div>
                                <span class="text-danger">
                                    @error('first_number')
                            ...
                            <div class="col-12 mt-2">
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        ...
                                        <input type="number" name="second_number" class="form-control" value="{{old('second_number')}}"
                                            id="exampleFormControlInputText1" placeholder="Enter Vendor Phone Number">
                                    </div>
                                </div>
                                <span class="text-danger">
                                ...
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        ...
                                        <textarea type="text" name="address" class="form-control" 
                                            id="exampleFormControlInputText1" placeholder="Enter Vendor Address">{{old('address')}}</textarea>
                                    </div>
                                </div>
                                <span class="text-danger">
                                    @error('address')
                                ...
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        ...
                                        <input type="number" name="pin" class="form-control" value="{{old('pin')}}"
                                            id="exampleFormControlInputText1" placeholder="Enter Vendor PinCode">
                                    </div>
                                </div>
                                <span class="text-danger">
                                    @error('pin')
