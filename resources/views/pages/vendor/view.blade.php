                ...
                <div class="card-body">
                    <div class="">
                        <div class="d-flex" style="justify-content: space-between;">
                            <h4 style="font-size: 20px;">Vendors List</h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown-menu drop_option">
                                                    <ul>
                                                        <li>
                                                            <a href="{{ route('vendors.edit', encrypt($item->id)) }}">Edit</a>
                                                        </li>
                                                        <li>
                                                        ...
                                                        <form action="{{ route('vendors.destroy',encrypt($item->id)) }}"
                                                    ...
                                                    <div class="modal-dialog modal-md">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p>Are You Sure You Want To Detele This Vendor</p>
                                                            </div>
