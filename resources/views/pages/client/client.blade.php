            ...
            <div class="card-body">
                <div class="row justify-content-between">
                    ...
                    <div class="d-flex" style="justify-content: space-between">
                        <h4 style="margin-bottom: 15px; font-size: 20px;">Add Party </h4>
                                ...
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            id="exampleFormControlInputText1" placeholder="Enter Party Name">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        ...
                                        <input type="email" name="email" class="form-control"
                                            id="exampleFormControlInputText1" placeholder="Enter Party Email">
                                    </div>
                                </div>
                                <span class="text-danger">
                                    @error('email')
                                ...
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        ...
                                        <input type="number" name="first_number" class="form-control"
                                            id="exampleFormControlInputText1" placeholder="Enter Party Phone Number">
                                    </div>
                                </div>
                                <span class="text-danger">
                                    @error('first_number')
                                ...
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        ...
                                        <textarea type="text" name="address" class="form-control"
                                            id="exampleFormControlInputText1" placeholder="Enter Party Address"></textarea>
                                    </div>
                                </div>
                                <span class="text-danger">
                                    @error('address')
                                ...
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        ...
                                        <input type="number" name="pin" class="form-control"
                                            id="exampleFormControlInputText1" placeholder="Enter Party PinCode">
                                    </div>
                                </div>
                                <span class="text-danger">
                                    @error('pin')
